...
adc.onclick = function(){
    const codeContent = 'Input your code.'; 
    const language = prompt("请输入语言") || "javascript"; 
    ...
    document.getElementById('pinfo').appendChild(pre);
